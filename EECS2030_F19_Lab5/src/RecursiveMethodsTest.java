...
//    public Timeout globalTimeout = Timeout.seconds(2);
	...
	@Test
	public void testArithmeticArray6() {
		RecursiveMethods rm = new RecursiveMethods();
		int[] seq = rm.arithmeticArray(4, 3, 1);
		int[] expected = {4};
		assertArrayEquals(expected, seq);
...
//	}
	...
	@Test
	public void testIsArithmeticArray11() {
		RecursiveMethods rm = new RecursiveMethods();
		int[] a = {3, 4, 5, 6, 7, 8};
		assertTrue(rm.isArithmeticArray(a));
	} 
	...
	@Test
	public void testIsArithmeticArray12() {
		RecursiveMethods rm = new RecursiveMethods();
		int[] a = {3, 4, 5, 6, 7, 1};
		assertFalse(rm.isArithmeticArray(a));
	}
	...
	@Test
	public void testIsArithmeticArray13() {
		RecursiveMethods rm = new RecursiveMethods();
		int[] a = {1, 4, 7, 6, 13, 16};
		assertFalse(rm.isArithmeticArray(a));
	}
...
//	}
	...
	@Test
	public void testMergeSortedArrays_8() {
		RecursiveMethods rm = new RecursiveMethods();
		int[] L = {3, 5};
		int[] R = {7, 4};
		int[] merge = rm.mergeSortedArrays(L, R);
