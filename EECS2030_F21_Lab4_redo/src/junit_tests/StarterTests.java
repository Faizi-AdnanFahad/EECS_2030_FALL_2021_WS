...
//	
	...
	public void test_channel_01e() { //
		Channel ch1 = new Channel("Cafe Music BGM", 3, 4);
		
		Follower f1 = new Subscriber("Alan", 20, 40);
		Follower f2 = new Monitor("Stat Sensor A", 60); 
		Follower f3 = new Monitor("Stat Sensor B", 60); 
		Follower f4 = new Monitor("Stat Sensor C", 60); 
	...
	public void test_channel_01g() { //
		Channel ch1 = new Channel("Cafe Music BGM", 3, 4);
		Channel ch2 = new Channel("Cafe Music BGM", 4, 4);
		assertTrue(ch1.getArrayOfFollowers() != ch2.getArrayOfFollowers());
	}
	
	@Test
	public void test_channel_01f() { //
		Channel ch1 = new Channel("Cafe Music1", 3, 4);
		Channel ch2 = new Channel("Cafe Music2", 3, 4);
		Channel ch3 = new Channel("Cafe Music3", 3, 4);

		Follower f1 = new Subscriber("Alan", 2, 40);
	...
	@Test
	public void test_channel_0h() { //
		Channel ch1 = new Channel("Cafe Music1", 3, 4);

		try {
			ch1.releaseANewVideo("a");
			ch1.releaseANewVideo("b");
			ch1.releaseANewVideo("v");
			ch1.releaseANewVideo("c");
		}
		catch (ArrayIndexOutOfBoundsException a) {
			fail();
		}
	...
	public void test_channel_03c() { 
		...
		Channel ch3 = new Channel("test1", 60, 135);
		ch3.follow(sub1);
		ch3.follow(mon1);
		
		assertEquals("Monitor Stat Sensor A follows [Cafe Music BGM {#views: 1, max watch time: 20, avg watch time: 20.00}, I Love You Venice, test1].", mon1.toString());
		/* All other channels and subscribers remain unchanged. */
		assertEquals("test1 released no videos and is followed by [Subscriber Alan, Monitor Stat Sensor A].", ch3.toString());
		assertEquals("Subscriber Alan follows [Cafe Music BGM, I Love You Venice, test1] and is recommended <Jazz Piano Radio, Baroque Live Music 24/7>.", sub1.toString());
		assertEquals("Monitor Stat Sensor A follows [Cafe Music BGM {#views: 1, max watch time: 20, avg watch time: 20.00}, I Love You Venice, test1].", mon1.toString()); 
		
		ch3.releaseANewVideo("b");
		assertEquals("Subscriber Alan follows [Cafe Music BGM, I Love You Venice, test1] and is recommended <Jazz Piano Radio, Baroque Live Music 24/7, b>.", sub1.toString());
		
		sub1.watch("b", 0);
		assertEquals("Monitor Stat Sensor A follows [Cafe Music BGM {#views: 1, max watch time: 20, avg watch time: 20.00}, I Love You Venice, test1 {#views: 1, max watch time: 0, avg watch time: 0.00}].", mon1.toString());
	...
	public void test_channel_03d() { 
		...
		Monitor mon3 = new Monitor("Stat Sensor C", 30);
		ch1.follow(mon3);
		
		ch1.releaseANewVideo("new vid");
		assertEquals("Monitor Stat Sensor C follows [Cafe Music BGM].", mon3.toString());
		assertEquals("Monitor Stat Sensor C follows [Cafe Music BGM].", mon3.toString());
		
		sub2.watch("new vid", 15);
		assertEquals("Monitor Stat Sensor C follows [Cafe Music BGM {#views: 1, max watch time: 15, avg watch time: 15.00}].", mon3.toString());

		sub2.watch("Jazz Piano Radio", 5);
		assertEquals("Monitor Stat Sensor C follows [Cafe Music BGM {#views: 2, max watch time: 15, avg watch time: 10.00}].", mon3.toString());

		assertEquals("Monitor Stat Sensor A follows [Cafe Music BGM {#views: 5, max watch time: 40, avg watch time: 21.00}, I Love You Venice].", mon1.toString());
